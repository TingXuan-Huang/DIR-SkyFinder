...
from skyfinder.training.dataloader import EVAL_TF
from skyfinder.training.engine import get_device, per_bin_mae
from skyfinder.training.fds import FDS
from skyfinder.training.model import FDSModel, build_model as make_model
...
def _eval_one_config(config: dict, run_name: str, fold: int,
    ...
    results_path = find_artifact(f"{run_name}_fold{fold}", ".json", results_dir)
